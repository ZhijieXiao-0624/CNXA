...
class ConvNeXtCaSa(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
        ...
        self.last_norm = nn.LayerNorm(dims[-1], eps=1e-6)  # final norm layer
...
def convnextcasa_base(num_classes: int):
    # https://dl.fbaipublicfiles.com/convnext/convnext_base_1k_224_ema.pth
    # https://dl.fbaipublicfiles.com/convnext/convnext_base_22k_224.pth
    model = ConvNeXtCaSa(depths=[3, 3, 27, 3],
...
if __name__ == '__main__':
    ...
    model = convnextcasa_base(num_classes=100)
